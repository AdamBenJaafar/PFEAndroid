 ...
 */
public class ItineraireDialogAdapter extends ArrayAdapter<Perturbation> {

    public ItineraireDialogAdapter(Context context, List<Perturbation> donationOptions) {
